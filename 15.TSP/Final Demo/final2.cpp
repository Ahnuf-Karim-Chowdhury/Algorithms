...
private:
    ...
    int reducedCost(int matrix[N][N]) {
        ...
        cout << "After Row Reduction the Matrix : " << endl;
        ...
        cout << "After Column Reduction the Matrix : " << endl;
        displayMatrix(matrix);
...
public:
    void TSPsoln(int matrix[N][N], int start) {
        ...
        if (found) {
            cout << "Shortest Path : ";
            for (int i : shortPath.pathNodes) cout << char('A' + i) << " -> ";
